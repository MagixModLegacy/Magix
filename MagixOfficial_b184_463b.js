...
new G.Unit({
	...
	new G.Unit({
		...
		finalStepCost:{'population':(250+(1*G.achievByName['Unhappy'].won+1/10)),'gem block':5,'blood':(100+(1*G.achievByName['Unhappy'].won))},
...
getCosts:function()
        {
            ...
            if (G.hasNot('Eotm')){
              ...
              return { 'insight' : calcCost('wisdom') , 'blood':calcCost(1+G.techN+G.year/10*G.achievByName['Unhappy'].won+1)}
