   ...
   new G.Res({
	...
	new G.Unit({
		...
		effects:[
			...
			{type:'convert',from:{'stick':3,'stone':2},into:{'Crossbow':1},every:5,req:{'Hunting II':true,'tool rafinery 2/2':false,'manufacture units II':false,'factories II':false},mode:'bows'},
        		{type:'convert',from:{'lumber':1,'stone':25},into:{'Crossbow belt':20},every:5,req:{'Hunting II':true,'tool rafinery 2/2':false,'manufacture units II':false,'factories II':false},mode:'bows'},
