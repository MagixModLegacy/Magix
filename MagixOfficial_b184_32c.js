...
///UNIVERSITY LEVELLING
			...
			if(G.getUnitByName('scientific university').mode==4 && G.has('Bigger university') && G.getRes('university point').amount==400)G.getUnitByName('scientific university').mode==4;G.getDict('scientific university').icon=[16,29,'magixmod'];G.getDict('scientific university').wideIcon=[15,29,'magixmod'];
		},
		getDisplayAmount:researchGetDisplayAmount,
		whenGathered:researchWhenGathered,
	});
