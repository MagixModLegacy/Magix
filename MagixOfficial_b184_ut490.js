...
new G.Unit({
	...
	if(G.modsByName['Market mod']){
		...
		modes:{
			...
			'fire':{name:'F.e',icon:[0,2,'magixmod'],desc:'Trades 200 [Fire essence] for some [market_coin] ',req:{'extended essences catalog':'on'}},
			'wind':{name:'Wi.e',icon:[1,1,'magixmod'],desc:'Trades 200 [Wind essence] for some [market_coin] ',req:{'extended essences catalog':'on'}},
			'dark':{name:'D.e',icon:[1,3,'magixmod'],desc:'Trades 200 [Dark essence] for some [market_coin] ',req:{'extended essences catalog':'on'}},
			'wate':{name:'W.e',icon:[0,1,'magixmod'],desc:'Trades 200 [Water essence] for some [market_coin] ',req:{'extended essences catalog':'on'}},
			'ligh':{name:'L.e',icon:[0,3,'magixmod'],desc:'Trades 200 [Lightning essence] for some [market_coin] ',req:{'extended essences catalog':'on'}},
			'natu':{name:'N.e',icon:[1,2,'magixmod'],desc:'Trades 200 [Nature essence] for some [market_coin] ',req:{'extended essences catalog':'on'}},
			'holy':{name:'H.e',icon:[20,6,'magixmod'],desc:'Trades 200 [Essence of the Holiness] for some [market_coin] ',req:{'extended essences catalog':'on'}},
		},
		effects:[
