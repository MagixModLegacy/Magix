...
//Unit gets converted. Needed to make mine collapsions possible or other wasting with wounding people and else things
	...
	//Units for real
		...
		category:'crafting',
		effects:[
			({type:'convert',from:{'Lavender':2},into:{'Purple dye':10},every:4}),
		({type:'convert',from:{'Salvia':6},into:{'Magenta dye':2},every:5}),
		({type:'convert',from:{'Bachelor\'s button':6},into:{'Blue dye':2},every:4}),
		({type:'convert',from:{'Desert rose':6},into:{'Magenta dye':2},every:5}),
		({type:'convert',from:{'Cosmos':4},into:{'Magenta dye':2},every:4}),
		({type:'convert',from:{'Pink rose':6},into:{'Pink dye':2},every:5}),
		({type:'convert',from:{'Pink tulip':4},into:{'Pink dye':2},every:4}),
		({type:'convert',from:{'Coreopsis':4},into:{'Yellow dye':2},every:5}),
		({type:'convert',from:{'Crown imperial':4},into:{'Orange dye':2},every:4}),
		({type:'convert',from:{'Cyan rose':4},into:{'Cyan dye':2},every:5}),
		({type:'convert',from:{'Himalayan blue poopy':4},into:{'Cyan dye':2},every:5}),
		({type:'convert',from:{'Cockscomb':4},into:{'Red dye':2},every:4}),
		({type:'convert',from:{'Red tulip':4},into:{'Red dye':2},every:5}),
		({type:'convert',from:{'Green Zinnia':6},into:{'Green dye':2},every:5}),
		({type:'convert',from:{'cactus':4},into:{'Green dye':2,'Cactus spikes':4},every:5}),
		({type:'convert',from:{'Lime rose':4},into:{'Lime dye':2},every:5}),
		({type:'convert',from:{'Lime tulip':4},into:{'Lime dye':2},every:5}),
		({type:'convert',from:{'Azure bluet':8},into:{'Light gray dye':2},every:5}),
		({type:'convert',from:{'Daisy':4},into:{'Light gray dye':2},every:5}),
		({type:'convert',from:{'Sunflower':2},into:{'Yellow dye':2,'Sunflower seeds':6},every:7}),
		({type:'convert',from:{'Dandelion':4},into:{'Yellow dye':2},every:5}),
		({type:'convert',from:{'Black lily':6},into:{'Black dye':2},every:5}),
		({type:'convert',from:{'Black Hollyhock':4},into:{'Black dye':2},every:5}),
		({type:'convert',from:{'Cattail':4},into:{'Brown dye':2},every:5}),
		({type:'convert',from:{'Flax':3},into:{'Light blue dye':1},every:5}),
		({type:'convert',from:{'Blue orchid':2},into:{'Light blue dye':1},every:5}),
		({type:'convert',from:{'White tulip':2},into:{'White dye':1},every:5}),
		({type:'convert',from:{'Lily of the Valley':3},into:{'White dye':1},every:5}),
		({type:'convert',from:{'Brown flower':2},into:{'Brown dye':1},every:5}),
		({type:'convert',from:{'Gray rose':3},into:{'Gray dye':1},every:5}),
		({type:'convert',from:{'Gray tulip':2},into:{'Gray dye':1},every:5}),
