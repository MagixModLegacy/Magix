...
/*=====================================================================================
	...
	UPDATELOG=[
	{date:'2013-2014',title:'Prototype',text:['started working on a prototype for a cross between Civilization and an idle game after the sudden success of my game, <a href="http://orteil.dashnet.org/cookieclicker/" target="_blank">Cookie Clicker</a>','encountered some issues with gameplay design and ended up putting the project on hold']},
	{date:'2015',title:'Prototype, part II',text:['the broken, buggy prototype has been <a href="http://orteil.dashnet.org/experiments/legacy/" target="_blank">put online for all to see</a>']},
	...
	{date:'3/28/2021',title:'Alpha patch 7',text:['unit modes now have icons','added custom bulk-buying in units','gathering was reworked, expect different rates for resource production','workers dying while working probably won\'t result in ghost workers anymore','units have innate priorities in the context of being created and acting, with food-producing units going first','happier people now produce more babies, while unhappy people just aren\'t feeling it as much','corpses decay slowly']},
];
	/*=====================================================================================
	RESOURCES
	=======================================================================================*/
