...
//skull achiev
	...
	new G.Achiev({
		tier:0,
		name:'obsessed?',
		icon:[9,15,'seasonal',16,16,'seasonal'],
...
var len=G.techsOwned.length;
 ...
 /* techResearched.l = l(`tech-${techResearched.id}`);
  ...
  G.draw.tech();
		...
		var str='';
		str+=
			'<p style="float:right;">Thanks to Hyoretsu for helping with coding this tab</p><div class="behindBottomUI">'+
   ...
   new G.Res({
	...
	new G.Unit({
		...
		effects:[
			...
			{type:'convert',from:{'Thread':1.5,'herb':0.75},into:{'First aid things':1},every:7,mode:'craftfirstaid'},
       			{type:'convert',from:{'Thread':0.5,'herb':1},into:{'First aid things':1},every:7,mode:'craftfirstaid'},
       			{type:'convert',from:{'Thread':2,'herb':1.5,'hide':1},into:{'First aid things':1},every:9,mode:'craftfirstaid'},
			{type:'convert',from:{'Lavender':2},into:{'Dyes':1},every:7,mode:'dyes1'},
        		{type:'convert',from:{'Salvia':3},into:{'Dyes':1},every:7,mode:'dyes1'},
        		{type:'convert',from:{'Bachelor\'s button':2},into:{'Dyes':1},every:7,mode:'dyes1'},
       			{type:'convert',from:{'Desert rose':2},into:{'Dyes':1},every:7,mode:'dyes1'},
        		{type:'convert',from:{'Cosmos':2},into:{'Dyes':1},every:7,mode:'dyes1'},
       			{type:'convert',from:{'Pink rose':3},into:{'Dyes':1},every:7,mode:'dyes1'},
        		{type:'convert',from:{'Pink tulip':2},into:{'Dyes':1},every:7,mode:'dyes1'},
        		{type:'convert',from:{'Coreopsis':2},into:{'Dyes':1},every:7,mode:'dyes1'},
        		{type:'convert',from:{'Crown imperial':2},into:{'Dyes':1},every:7,mode:'dyes2'},
       			{type:'convert',from:{'Cyan rose':2},into:{'Dyes':1},every:7,mode:'dyes2'},
        		{type:'convert',from:{'Himalayan blue poopy':2},into:{'Dyes':1},every:7,mode:'dyes2'},
       			{type:'convert',from:{'Cockscomb':2},into:{'Dyes':1},every:7,mode:'dyes2'},
        		{type:'convert',from:{'Red tulip':2},into:{'Dyes':1},every:7,mode:'dyes2'},
        		{type:'convert',from:{'Green Zinnia':3},into:{'Dyes':1},every:7,mode:'dyes2'},
        		{type:'convert',from:{'cactus':2},into:{'Dyes':1},every:7,mode:'dyes2'},
        		{type:'convert',from:{'Lime rose':2},into:{'Dyes':1},every:7,mode:'dyes2'},
        		{type:'convert',from:{'Lime tulip':2},into:{'Dyes':1},every:7,mode:'dyes3'},
        		{type:'convert',from:{'Azure bluet':4},into:{'Dyes':1},every:7,mode:'dyes3'},
       			{type:'convert',from:{'Daisy':2},into:{'Dyes':1},every:7,mode:'dyes3'},
        		{type:'convert',from:{'Sunflower':1},into:{'Dyes':1},every:9,mode:'dyes3'},
        		{type:'convert',from:{'Dandelion':2},into:{'Dyes':1},every:7,mode:'dyes3'},
        		{type:'convert',from:{'Black lily':3},into:{'Dyes':1},every:7,mode:'dyes3'},
        		{type:'convert',from:{'Black Hollyhock':2},into:{'Dyes':1},every:7,mode:'dyes3'},
        		{type:'convert',from:{'Cattail':2},into:{'Dyes':1},every:7,mode:'dyes3'},
			{type:'convert',from:{'stick':3,'stone':2},into:{'Crossbow':1},every:7,req:{'Hunting II':true,'manufacture units II':false,'factories II':false},mode:'bows'},
        		{type:'convert',from:{'lumber':1,'stone':25},into:{'Crossbow belt':20},every:7,req:{'Hunting II':true,'manufacture units II':false,'factories II':false},mode:'bows'},
    			{type:'convert',from:{'Flax':3},into:{'Dyes':1},every:7,mode:'dyes4'},
        		{type:'convert',from:{'Blue orchid':2},into:{'Dyes':1},every:7,mode:'dyes4'},
        		{type:'convert',from:{'White tulip':2},into:{'Dyes':1},every:7,mode:'dyes4'},
        		{type:'convert',from:{'Lily of the Valley':3},into:{'Dyes':1},every:7,mode:'dyes4'},
        		{type:'convert',from:{'Brown flower':2},into:{'Dyes':1},every:7,mode:'dyes4'},
        		{type:'convert',from:{'Gray rose':3},into:{'Dyes':1},every:7,mode:'dyes4'},
       		 	{type:'convert',from:{'Gray tulip':2},into:{'Dyes':1},every:7,mode:'dyes4'},
        		{type:'convert',from:{'Paper':30,'hide':1},into:{'Empty book':1},every:9,mode:'craftbook'},
			{type:'convert',from:{'Magic essences':2,'Beet seeds':1,'Mana':0.5},into:{'Essenced seeds':1},every:9,mode:'enchseeds'},
