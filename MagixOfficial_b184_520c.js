...
G.tabs=
	[
		...
		{name:'<font color="#7f7fff" onlick="function(){if(G.has(\'where am i?\')){G.showMap();}else{G.hideMap();}}">Territory</font>',showMap:false,id:'land',update:'land',desc:'View the world map, inspect explored territory and see your natural resources.'},
