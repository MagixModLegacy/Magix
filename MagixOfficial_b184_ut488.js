...
new G.Unit({
	...
	if(G.modsByName['Market mod']){
		...
		modes:{
			'off':G.MODE_OFF,
			'esse':{name:'Essences(all)',icon:[20,13,'magixmod'],desc:'Trades 500 [Magic essences] for some [market_coin]'},
			'fire':{name:'F.e',icon:[0,2,'magixmod'],desc:'Trades 200 [Fire essence] for some [market_coin] ',req:{'extened essences catalog'='on'}},
			'wind':{name:'Wi.e',icon:[1,1,'magixmod'],desc:'Trades 200 [Wind essence] for some [market_coin] ',req:{'extened essences catalog'='on'}},
			'dark':{name:'D.e',icon:[1,3,'magixmod'],desc:'Trades 200 [Dark essence] for some [market_coin] ',req:{'extened essences catalog'='on'}},
			'wate':{name:'W.e',icon:[0,1,'magixmod'],desc:'Trades 200 [Water essence] for some [market_coin] ',req:{'extened essences catalog'='on'}},
			'ligh':{name:'L.e',icon:[0,3,'magixmod'],desc:'Trades 200 [Lightning essence] for some [market_coin] ',req:{'extened essences catalog'='on'}},
			'natu':{name:'N.e',icon:[1,2,'magixmod'],desc:'Trades 200 [Nature essence] for some [market_coin] ',req:{'extened essences catalog'='on'}},
			'holy':{name:'H.e',icon:[20,6,'magixmod'],desc:'Trades 200 [Essence of the Holiness] for some [market_coin] ',req:{'extened essences catalog'='on'}},
		},
		effects:[
			{type:'convert',from:{'Magic essences':500},into:{'market_coin':14},every:5,mode:'esse'},
			{type:'convert',from:{'Fire essence':200},into:{'market_coin':14},every:5,mode:'fire'},
			{type:'convert',from:{'Wind essence':200},into:{'market_coin':14},every:5,mode:'wind'},
			{type:'convert',from:{'Dark essence':200},into:{'market_coin':14},every:5,mode:'dark'},
			{type:'convert',from:{'Water essence':200},into:{'market_coin':14},every:5,mode:'wate'},
			{type:'convert',from:{'Lightning essence':200},into:{'market_coin':14},every:5,mode:'ligh'},
			{type:'convert',from:{'Nature essence':200},into:{'market_coin':14},every:5,mode:'natu'},
			{type:'convert',from:{'Essence of the Holiness':200},into:{'market_coin':14},every:5,mode:'holy'},
		],
