...
G.props['fastTicksOnResearch']=150;
	...
	{   
			var dem=0;
			if(G.achievByName['Democration'].won>=1)dem=1;
		var str=
		...
		G.textWithTooltip('<div class="icon freestanding" style="'+G.getIconUsedBy(G.getRes('herb'))+'"></div><div class="freelabel">x300</div>','300 Herbs')+
		 (dem=1 ? G.textWithTooltip('<div class="icon freestanding" style="'+G.getIconUsedBy(G.getRes('herb'))+'"></div><div class="freelabel">x300</div>','300 Herbs'):"")+
