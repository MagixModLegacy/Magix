...
//FLOWERS!,DYES!
	...
	new G.Unit({
		...
		modes:{
			...
			//As long as fix won\'t be figured out i will paste the modes list for Clothier
			'Sew grass clothing':{name:'Sew grass clothing',icon:[15,7],desc:'Craft [primitive clothes] from 30 [herb]s each.',use:{'stone tools':1}},
			'Sew hide clothing':{name:'Sew hide clothing',icon:[15,7],desc:'Craft [primitive clothes] from 3 [hide]s each.',use:{'stone tools':1}},
			'Weave fiber clothing':{name:'Weave fiber clothing',icon:[16,7],desc:'Craft [basic clothes] from 50 [herb]s each.',use:{'stone tools':1},req:{'Sewing III':true,'Weaving II':true}},
