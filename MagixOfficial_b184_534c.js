 ...
 (!document.getElementById(cssId))
{
	...
	G.update['land']=function()
	{
		...
		if (G.inspectingTile) G.inspectTile(G.inspectingTile);
			...
			var texts= ['All you know for now that you exist at lands where scarce<br> not really occurs','All you know for now is that you exist in harsh, dry, <br>where food and water are scarce','You don\'t know where you are... You feel some warmth/cool , dryness/wettiness... Where?!'];
			var str='';
...
if (G.achievByName['Pocket'].won > 1 && G.hasNot('well stored 2')){
  ...
  var res = txt.endsWith("00");
	...
	setInterval(function(){if(la>lb){l('mapSection').style.display='block';}else{l('mapSection').style.display='none';}},200);
