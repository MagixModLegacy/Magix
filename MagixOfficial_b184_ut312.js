	...
	new G.Res({
		...
		tick:function(me,tick)
		{
			...
			if(G.has('Policy revaluation')){
				...
				if (G.ModLoaded('Laws Of Food','https://adrthegamedev.github.io/LawsOfFood/lawsoffood.js')==true || G.ModLoaded('Laws Of Food Free Version')==true){//Interaction with laws of food mod!
