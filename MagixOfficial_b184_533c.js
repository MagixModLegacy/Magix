 ...
 (!document.getElementById(cssId))
{
	...
	G.update['land']=function()
	{
		...
		if (G.inspectingTile) G.inspectTile(G.inspectingTile);
			...
			var texts= ['All you know for now is that you exist in harsh, dry, <br>where food and water are scarce','All you know for now that you exist at lands where scarce<br> not really occurs','You don\'t know where you are... You feel some warmth/cool , dryness/wettiness... Where?!'];
			var str='';
