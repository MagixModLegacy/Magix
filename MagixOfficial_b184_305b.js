...
G.props['fastTicksOnResearch']=150;
	...
	{   
		...
		'if(G.achievByName["Democration"].won>=1){'+
				return G.textWithTooltip('<div class="icon freestanding" style="'+G.getIconUsedBy(G.getRes('influence'))+'"></div><div class="freelabel">x1</div>','1 extra Influence & Authority')+
		'}'+
				'</script>'+
		'</div>'+
