	...
	new G.Res({
		...
		tick:function(me,tick)
		{
			...
			if(G.has('Policy revaluation')){
				...
				if (G.ModLoaded('Laws Of Food','https://adrthegamedev.github.io/LawsOfFood/lawsoffood.js') || G.ModLoaded ('Laws Of Food Free Version','https://adrthegamedev.github.io/LawsOfFood/lawsoffoodfree.js')){//Interaction with laws of food mod!
