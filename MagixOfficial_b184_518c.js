...
G.tabs=
	[
		...
		{name:'<font color="#7f7fff">Territory</font>',showMap:function(){if(G.has('where am i?')){G.showMap();}else{G.hideMap();}},id:'land',update:'land',desc:'View the world map, inspect explored territory and see your natural resources.'},
